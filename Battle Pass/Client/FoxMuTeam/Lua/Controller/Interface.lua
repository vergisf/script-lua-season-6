...
if CheckRepeatKey(Keys.ControlKey) == 1 then
		if CheckWindowOpen(Keys.Tab) == 1 or  CheckWindowOpen(Keys.Tab) == 1 then
			DisableClickClient()
		end 
	end

if CheckWindowOpen(UIChatBox) == 1 then
       if CheckPressedKey(Keys.Tab) == 1 or CheckPressedKey(Keys.Tab) == 1 then
            DisableClickCliente()
...
OpenFolder("Customs//Config")
OpenFolder("Customs//Systems")
OpenFolder("Customs//Utils")
