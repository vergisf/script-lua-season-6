...
function PacotePromocional.TrySpin(player, pacoteIndex)
	...
	PacotePromocional.CreateItensPlayer(playerInfo, prize)
...
function PacotePromocional.CreateItensPlayer(playerInfo, prize)
    for index in ipairs(prize) do
        itemShop = prize[index]
        for _ = 1, itemShop.Count do 
            NpcRescueItem.InsertItem(playerInfo[0], itemShop.ItemIndex, itemShop.Level, itemShop.Skill, itemShop.Luck, itemShop.JoL, itemShop.Exc, 0, 0, 255, 255, 255, 255, 255, 255, 60, itemShop.Days*86400)
        end
    end
end
